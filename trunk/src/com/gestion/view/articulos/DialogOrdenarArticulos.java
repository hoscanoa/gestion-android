...
public class DialogOrdenarArticulos extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		int criterio = mPreferencia.getCriterioOrdenarArticulo();
		builder.setSingleChoiceItems(R.array.OrdenarArticulo, criterio,
				new OnClickListener() {
